...
- **Recommended title: `Status Saver App for WhatsApp`** (29 chars) — no collision in the 217-listing scrape, carries three board phrases word for word and every word of ten more, for **15%** of the whole US board's priority against 13% for the generic-only `Status Saver & Downloader App`. Our own word stays first, so it reads as our product working with WhatsApp, not as WhatsApp's own app — that is the line the impersonation policy draws. Leading with the brand scores no better and reads first-party.
- **The copy names WhatsApp and carries the disclaimer that keeps it descriptive**: independent utility, not affiliated/sponsored/endorsed, trademarks belong to WhatsApp LLC, no modification of WhatsApp, no support for modified clients, no message recovery. Do not drop any of it — it is what makes the naming defensible.
...
- Store-listing and ad copy **may name WhatsApp and WhatsApp Business**, to say what the app reads and nothing more. What is banned is impersonation, not the name: never use the WhatsApp mark or logo in the icon, feature graphic or screenshots; never lead the title with the brand; never say or imply "official", "affiliated" or "endorsed"; always keep our own word first in the title and the disclaimer in the description.
